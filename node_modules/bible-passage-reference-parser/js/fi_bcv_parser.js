    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|1[\s\xa0]*Moos|Gen|I[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|2[\s\xa0]*Moos|Exod|II[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Bel(?:[\\s\\xa0]*ja[\\s\\xa0]*lohik[a\\xE4][a\\xE4]rme)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|3[\s\xa0]*Moos|Lev|III[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:III|3)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Kolmas[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4[\s\xa0]*Moos(?:eksen(?:[\s\xa0]*kirja)?)?|IV[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:IV|4)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|N(?:elj[a\xE4]s[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|um)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sii?rakin[\\s\\xa0]*kirja)|(?:Jee?sus[\\s\\xa0]*Siirakin[\\s\\xa0]*kirja|Si(?:i?rakin|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Viis(?:auden[\\s\\xa0]*kirja)?|Wis|Salomon[\\s\\xa0]*viisaus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        ...
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ilmestyskirja|Rev|Ilm(?:estys)?|Johanneksen[\\s\\xa0]*ilmestys))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:V(?:\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|iides[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?)|5[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|5[\s\xa0]*Moos|Deut|5\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jo(?:os(?:uan(?:[\\s\\xa0]*kirja)?)?|sh)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tuom(?:arien(?:[\\s\\xa0]*kirja)?)?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ru(?:ut(?:in(?:[\\s\\xa0]*kirja)?)?|th)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Esra|Esd))|(?:I[\s\xa0]*Esra|1[\s\xa0]*Es|[1I]\.[\s\xa0]*Esra|Ensimm[a\xE4]inen[\s\xa0]*Esra))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Esra|Esd))|(?:(?:II|2)\.[\s\xa0]*Esra|II[\s\xa0]*Esra|2[\s\xa0]*Es|Toinen[\s\xa0]*Esra))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jes(?:ajan(?:[\\s\\xa0]*kirja)?)?|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[\s\xa0]*?Sam)|II[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[\s\xa0]*?Sam)|I[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[\s\xa0]*Kun|Kgs)|II[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[\s\xa0]*Kun|Kgs)|I[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Aikakirja)|(?:2(?:[\s\xa0]*Aikak|Chr|[\s\xa0]*Aik)|II[\s\xa0]*Aikakirja|(?:II|2)\.[\s\xa0]*Aikakirja|Toinen[\s\xa0]*Aikakirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Aikakirja)|(?:1(?:[\s\xa0]*Aikak|Chr|[\s\xa0]*Aik)|I[\s\xa0]*Aikakirja|[1I]\.[\s\xa0]*Aikakirja|Ensimm[a\xE4]inen[\s\xa0]*Aikakirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:E(?:sr(?:a(?:n(?:[\\s\\xa0]*kirja)?)?)?|zra)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Neh"],
        ...
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kr(?:eikkalainen[\\s\\xa0]*Esterin(?:[\\s\\xa0]*kirja)?|\\.?[\\s\\xa0]*Est)|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Esth"],
        ...
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S(?:ananl(?:asku(?:jen(?:[\\s\\xa0]*kirja)?|t))?|nl)|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Saar(?:n(?:aaja(?:n(?:[\\s\\xa0]*kirja)?)?)?)?|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kolmen[\\s\\xa0]*(?:nuoren[\\s\\xa0]*miehen(?:[\\s\\xa0]*ollessa[\\s\\xa0]*tulisessa[\\s\\xa0]*p[a\\xE4]tsiss[a\\xE4])?|miehen(?:[\\s\\xa0]*kiitosvirsi[\\s\\xa0]*tulessa|[\\s\\xa0]*kiitosvirsi)?)|SgThree))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Laul(?:ujen[\\s\\xa0]*laulu|\\.?[\\s\\xa0]*l)|Korkea[\\s\\xa0]*veisu|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jer(?:emian(?:[\\s\\xa0]*kirja)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hes(?:ekielin(?:[\\s\\xa0]*kirja)?)?|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        ...
        osis: ["Amos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:A(?:am(?:oksen(?:[\\s\\xa0]*kirja)?)?|mos)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ob(?:ad(?:j(?:an(?:[\\s\\xa0]*kirja)?)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jo(?:on(?:a(?:n(?:[\\s\\xa0]*kirja)?)?)?|nah)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sef(?:anjan(?:[\\s\\xa0]*kirja)?)?|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hag(?:g(?:ain(?:[\\s\\xa0]*kirja)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sak(?:arjan(?:[\\s\\xa0]*kirja)?)?|Zech))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mal(?:akian(?:[\\s\\xa0]*kirja)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Matt(?:euksen[\\s\\xa0]*evankeliumi|euksen)?|Evankeliumi[\\s\\xa0]*Matteuksen[\\s\\xa0]*mukaan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mark(?:uksen[\\s\\xa0]*evankeliumi|uksen)?|Evankeliumi[\\s\\xa0]*Markuksen[\\s\\xa0]*mukaan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lu(?:ukkaan[\\s\\xa0]*evankeliumi|ke|uk(?:kaan)?)|Evankeliumi[\\s\\xa0]*Luukkaan[\\s\\xa0]*mukaan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1John)|(?:1[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|I[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[1I]\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|Ensimm[a\xE4]inen[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2John)|(?:(?:II|2)\.[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|(?:II|2)[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|Toinen[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3John)|(?:3[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|III[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|(?:III|3)\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|Kolmas[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Joh(?:anneksen[\\s\\xa0]*evankeliumi|n|anneksen)?|Evankeliumi[\\s\\xa0]*Johanneksen[\\s\\xa0]*mukaan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:A(?:p(?:ostolien[\\s\\xa0]*teo|\\.?[\\s\\xa0]*|\\.)?t|cts)|Teot))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Roomalaisille)|(?:Ro(?:omalaiskirje|o?m)|Kirje[\\s\\xa0]*roomalaisille))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Korinttilaisille)|(?:2(?:[\s\xa0]*Korinttolaiskirje|(?:[\s\xa0]*K|C)or|[\s\xa0]*Kirje[\s\xa0]*korinttilaisille)|II[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e|(?:II|2)\.[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e|Toinen[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Korinttilaisille)|(?:1(?:[\s\xa0]*Korinttolaiskirje|(?:[\s\xa0]*K|C)or|[\s\xa0]*Kirje[\s\xa0]*korinttilaisille)|I[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e|[1I]\.[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e|Ensimm[a\xE4]inen[\s\xa0]*K(?:orintt(?:olaiskirj|ilaisill)|irje[\s\xa0]*korinttilaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Gal(?:atalaisille|atalaiskirj)?|Kirje[\\s\\xa0]*galatalaisille))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Efesolaisille)|(?:E(?:fesolaiskirje|ph|f)|Kirje[\\s\\xa0]*efesolaisille))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Filippil[a\\xE4]isille)|(?:Filippil[a\\xE4]iskirje|(?:Ph|F)il|Kirje[\\s\\xa0]*filippil[a\\xE4]isille))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:K(?:ol(?:ossalaiskirje|ossalaisille)?|irje[\\s\\xa0]*kolossalaisille)|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Tessalonikalaisille)|(?:2(?:[\s\xa0]*Tessalonikalaiskirje|(?:[\s\xa0]*T|Th)ess|[\s\xa0]*Kirje[\s\xa0]*tessalonikalaisille)|II[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|(?:II|2)\.[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|Toinen[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Tessalonikalaisille)|(?:1(?:[\s\xa0]*Tessalonikalaiskirje|(?:[\s\xa0]*T|Th)ess|[\s\xa0]*Kirje[\s\xa0]*tessalonikalaisille)|I[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|[1I]\.[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|Ensimm[a\xE4]inen[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Timoteukselle)|(?:II[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|2(?:[\s\xa0]*Kirje[\s\xa0]*Timoteukselle|[\s\xa0]*Timoteuskirje|[\s\xa0]*?Tim)|(?:II|2)\.[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|Toinen[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Timoteukselle)|(?:I[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|1(?:[\s\xa0]*Kirje[\s\xa0]*Timoteukselle|[\s\xa0]*Timoteuskirje|[\s\xa0]*?Tim)|[1I]\.[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|Ensimm[a\xE4]inen[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tit(?:ukselle|us)?|Kirje[\\s\\xa0]*Titukselle))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Filemonille)|(?:Kirje[\\s\\xa0]*Filemonille|(?:File|Phl)m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:He(?:prealaisille|br))|(?:He(?:prealaiskirje|pr|b)|Kirje[\\s\\xa0]*he[bp]realaisille))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ja(?:ak(?:obin(?:[\\s\\xa0]*kirje)?)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:[\s\xa0]*Pi|P)et)|II[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:II|2)\.[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|Toinen[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:[\s\xa0]*Pi|P)et)|I[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|[1I]\.[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|Ensimm[a\xE4]inen[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ju(?:ud(?:aksen(?:[\\s\\xa0]*kirje)?)?|de)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tob(?:i(?:a(?:an(?:[\\s\\xa0]*kirja)?|n(?:[\\s\\xa0]*kirja)?)|tin(?:[\\s\\xa0]*kirja)?))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:J(?:ud(?:itin(?:[\\s\\xa0]*kirja)?)?|dt)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ba(?:r(?:ukin(?:[\\s\\xa0]*kirja)?)?|arukin(?:[\\s\\xa0]*kirja)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sus"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|II[\s\xa0]*makkabilaiskirja|(?:II|2)\.[\s\xa0]*makkabilaiskirja|Toinen[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|III[\s\xa0]*makkabilaiskirja|(?:III|3)\.[\s\xa0]*makkabilaiskirja|Kolmas[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|IV[\s\xa0]*makkabilaiskirja|(?:IV|4)\.[\s\xa0]*makkabilaiskirja|Nelj[a\xE4]s[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|I[\s\xa0]*makkabilaiskirja|[1I]\.[\s\xa0]*makkabilaiskirja|Ensimm[a\xE4]inen[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
