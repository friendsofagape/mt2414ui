(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:NB(?:G51|V)|SV77|WV95|NB|SV|GNB96))\b/gi;
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Genesis)|(?:(?:1e?|I)[\s\xa0]*Mozes|Beresjiet|Ge?n|(?:1e?|I)\.[\s\xa0]*Mozes|Eerste[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Exodus)|(?:(?:2e?|II)[\s\xa0]*Mozes|Sjemot|Exod|Ex|(?:2e?|II)\.[\s\xa0]*Mozes|Tweede[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Leviticus)|(?:(?:3e?|III)[\s\xa0]*Mozes|[VW]ajikra|Le?v|(?:3e?|III)\.[\s\xa0]*Mozes|Derde[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:B[ae]midbar|Numb?eri|Num?|(?:IV|4)[\s\xa0]*Mozes|(?:IV|4)\.[\s\xa0]*Mozes|Vierde[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sirach)|(?:Wijsheid[\\s\\xa0]*van[\\s\\xa0]*(?:J(?:ozua[\\s\\xa0]*Ben|ezus)|Ben)[\\s\\xa0]*Sirach|Ecclesiasticus|Sir|Jezus[\\s\\xa0]*Sirach))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Wijsheid[\\s\\xa0]*van[\\s\\xa0]*Salomo)|(?:Het[\\s\\xa0]*boek[\\s\\xa0]*der[\\s\\xa0]*wijsheid|Wi(?:jsheid|s)|De[\\s\\xa0]*wijsheid[\\s\\xa0]*van[\\s\\xa0]*Salomo))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kl(?:aagl(?:iederen)?)?|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        ...
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Op(?:enb(?:aring(?:[\\s\\xa0]*van[\\s\\xa0]*Johannes|en)?)?)?|Ap[ck]|Rev|Apocalyps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Man(?:asse)?|PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:D(?:e(?:ut(?:eronomium)?|wariem)|t)|(?:V(?:ijfde|\.)?|5\.?)[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jo(?:z(?:ua)?|sh)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:R(?:i(?:cht(?:eren?)?)?|e(?:chters|cht)?)|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[13]e|[13]|I(?:II)?)[\s\xa0]*E(?:sdras|zra)|1Esd|(?:[13]e|[13]|I(?:II)?)\.[\s\xa0]*E(?:sdras|zra)|Derde[\s\xa0]*E(?:sdras|zra)|Eerste[\s\xa0]*E(?:sdras|zra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:I[IV]|4|2e?)[\s\xa0]*E(?:sdras|zra)|2Esd|(?:I[IV]|4|2e?)\.[\s\xa0]*E(?:sdras|zra)|Vierde[\s\xa0]*E(?:sdras|zra)|Tweede[\s\xa0]*E(?:sdras|zra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:J(?:es(?:aja)?|s)|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Sam(?:u[e\xEB]l)?|Samuel[\s\xa0]*II|2Sam|2[\s\xa0]*S|(?:2e|II)[\s\xa0]*Sam(?:u[e\xEB]l)?|(?:2e?|II)\.[\s\xa0]*Sam(?:u[e\xEB]l)?|Tweede[\s\xa0]*Sam(?:u[e\xEB]l)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Sam(?:u[e\xEB]l)?|Samuel[\s\xa0]*I|1Sam|1[\s\xa0]*S|(?:1e|I)[\s\xa0]*Sam(?:u[e\xEB]l)?|(?:1e?|I)\.[\s\xa0]*Sam(?:u[e\xEB]l)?|Eerste[\s\xa0]*Sam(?:u[e\xEB]l)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2e?|II)[\s\xa0]*Ko(?:n(?:ingen)?)?|2Kgs|(?:2e?|II)\.[\s\xa0]*Ko(?:n(?:ingen)?)?|Tweede[\s\xa0]*Ko(?:n(?:ingen)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1e?|I)[\s\xa0]*Ko(?:n(?:ingen)?)?|1Kgs|(?:1e?|I)\.[\s\xa0]*Ko(?:n(?:ingen)?)?|Eerste[\s\xa0]*Ko(?:n(?:ingen)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Kron(?:ieken)?|(?:[\s\xa0]*K|Ch)r)|(?:2e|II)[\s\xa0]*Kron(?:ieken)?|(?:2e?|II)\.[\s\xa0]*Kron(?:ieken)?|Tweede[\s\xa0]*Kron(?:ieken)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Kron(?:ieken)?|(?:[\s\xa0]*K|Ch)r)|(?:1e|I)[\s\xa0]*Kron(?:ieken)?|(?:1e?|I)\.[\s\xa0]*Kron(?:ieken)?|Eerste[\s\xa0]*Kron(?:ieken)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Spr(?:euken)?|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Prediker|Eccl|Pr(?:ed)?|[KQ]oheleth?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lied[\\s\\xa0]*van[\\s\\xa0]*de[\\s\\xa0]*drie[\\s\\xa0]*jongemannen|SgThree|Gezang[\\s\\xa0]*der[\\s\\xa0]*drie[\\s\\xa0]*mannen[\\s\\xa0]*in[\\s\\xa0]*het[\\s\\xa0]*vuur))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:H(?:ooglied|l)|Song|Hoogl|Canticum[\\s\\xa0]*canticorum))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:J(?:er(?:emia)?|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Eze(?:ch(?:i[e\\xEB]l)?|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Da(?:n(?:i[e\\xEB]l)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hos(?:ea)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:J(?:o[e\\xEB])?l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Amos"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ze(?:f(?:anja)?|ph)|Sef(?:anja)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hag(?:g(?:a[i\\xEF])?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        ...
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:M(?:att(?:h[e\\xE9]|e)[u\\xFC]s|at(?:th?)?|t)|Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Matte[u\\xFC]s))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mar[ck]us)|(?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Mar[ck]us|M(?:ar[ck]|[ckr])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lu[ck]as)|(?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Lu[ck]as|L(?:u(?:ke|c)|[ck]|uk)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1John)|(?:(?:1e?|I)\.[\s\xa0]*Joh(?:annes)?|(?:1e?|I)[\s\xa0]*Joh(?:annes)?|Eerste[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2John)|(?:(?:2e?|II)\.[\s\xa0]*Joh(?:annes)?|(?:2e?|II)[\s\xa0]*Joh(?:annes)?|Tweede[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3John)|(?:(?:3e?|III)\.[\s\xa0]*Joh(?:annes)?|(?:3e?|III)[\s\xa0]*Joh(?:annes)?|Derde[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:H(?:and(?:elingen(?:[\\s\\xa0]*(?:van[\\s\\xa0]*de|der)[\\s\\xa0]*apostelen)?)?|nd)|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Rom(?:einen(?:brief)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2e?|II)[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|2Cor|(?:2e?|II)\.[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|Tweede[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1e?|I)[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|1Cor|(?:1e?|I)\.[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|Eerste[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Gal(?:aten(?:brief)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:E(?:f(?:ez(?:i[e\\xEB]rs)?)?|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Fil(?:ip(?:penzen)?)?|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CK]ol(?:ossenzen)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2e|II)[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|2(?:[\s\xa0]*Th?ess(?:alonicenzen)?|(?:[\s\xa0]*Th?e|Thes)s)|(?:2e?|II)\.[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|Tweede[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1e|I)[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|1(?:[\s\xa0]*Th?ess(?:alonicenzen)?|(?:[\s\xa0]*Th?e|Thes)s)|(?:1e?|I)\.[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|Eerste[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2e?|II)[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|2Tim|(?:2e?|II)\.[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|Tweede[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1e?|I)[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|1Tim|(?:1e?|I)\.[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|Eerste[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tit(?:us)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Fil(?:em(?:on)?|\\xE9mon|m)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Heb(?:r(?:ee[e\\xEB]n)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ja(?:k(?:obus)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pe|Pet)|(?:2e|II)[\s\xa0]*Pet(?:r(?:us)?)?|(?:2e?|II)\.[\s\xa0]*Pet(?:r(?:us)?)?|Tweede[\s\xa0]*Pet(?:r(?:us)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pe|Pet)|(?:1e|I)[\s\xa0]*Pet(?:r(?:us)?)?|(?:1e?|I)\.[\s\xa0]*Pet(?:r(?:us)?)?|Eerste[\s\xa0]*Pet(?:r(?:us)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tob(?:i(?:as?|t)|\\xEDas?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2e?|II)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|2Macc|(?:2e?|II)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Tweede[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:3e?|III)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|3Macc|(?:3e?|III)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Derde[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:IV|4)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|4Macc|(?:IV|4)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Vierde[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1e?|I)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|1Macc|(?:1e?|I)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Eerste[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezek", "Ezra"],
