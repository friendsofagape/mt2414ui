(function() {
  ...
  bcv_parser.prototype.languages = ["no"];
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Mos(?:ebok)?|Gen(?:esis)?|1\.[\s\xa0]*Mos(?:ebok)?|F\xF8rste[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Mos(?:ebok)?|Exod|2\.[\s\xa0]*Mos(?:ebok)?|An(?:dre[\s\xa0]*Mos(?:ebok)?|nen[\s\xa0]*Mosebok)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Bel(?:[\\s\\xa0]*og[\\s\\xa0]*dra(?:gen[\\s\\xa0]*i[\\s\\xa0]*Babylo|ke)n)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3[\s\xa0]*Mos(?:ebok)?|Lev(?:iticus)?|3\.[\s\xa0]*Mos(?:ebok)?|Tredje[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4[\s\xa0]*Mos(?:ebok)?|Num|4\.[\s\xa0]*Mos(?:ebok)?|Fjerde[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jesu[\\s\\xa0]*Siraks[\\s\\xa0]*s\\xF8nns[\\s\\xa0]*visdom|Sir(?:aks[\\s\\xa0]*bok|ak)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Visdommens[\\s\\xa0]*bok|Wis|Visd|Salomos[\\s\\xa0]*Visdom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        ...
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jer(?:emias[\\s\\xa0]*brev|br)|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[A\\xC5]penbaring(?:sbok)?en|Rev|[A\\xC5]p(?:enbaring)?|Johannes['’][\\s\\xa0]*[a\\xE5]penbaring))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Man(?:asses[\\s\\xa0]*b\\xF8nn)?|PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:5[\s\xa0]*Mos(?:ebok)?|Deut|5\.[\s\xa0]*Mos(?:ebok)?|Femte[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jos(?:va(?:s(?:[\\s\\xa0]*bok)?)?|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Dom(?:merne(?:s(?:[\\s\\xa0]*bok)?)?)?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Tredje|3\.?)[\s\xa0]*Esra|1Esd|1[\s\xa0]*Es(?:dras|ra)|1\.[\s\xa0]*Es(?:dras|ra)|F\xF8rste[\s\xa0]*Es(?:dras|ra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Fjerde|4\.?)[\s\xa0]*Esra|2Esd|2[\s\xa0]*Es(?:dras|ra)|2\.[\s\xa0]*Es(?:dras|ra)|Andre[\s\xa0]*Es(?:dras|ra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jesajas[\\s\\xa0]*bok)|(?:Jesajabok(?:en|a)|Isa|Jes(?:aja)?|Esaias(?:['’][\\s\\xa0]*bok)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Sam(?:uel(?:sbok)?)?|Sam|\.[\s\xa0]*Sam(?:uel(?:sbok)?)?)|Andre[\s\xa0]*Sam(?:uel(?:sbok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?|Sam|\.[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?)|F\xF8rste[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Kong(?:ebok)?|Kgs|\.[\s\xa0]*Kong(?:ebok)?)|Andre[\s\xa0]*Kong(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Kong(?:ebok)?|Kgs|\.[\s\xa0]*Kong(?:ebok)?)|F\xF8rste[\s\xa0]*Kong(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?|Chr|\.[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?)|Andre[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?|Chr|\.[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?)|F\xF8rste[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:E(?:sra(?:s(?:[\\s\\xa0]*bok)?)?|zra)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Neh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Neh(?:em(?:ja(?:s[\\s\\xa0]*bok)?|ias))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["GkEsth"],
        apocrypha: true,
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Asarjas[\\s\\xa0]*b\\xF8nn|PrAzar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Salomos[\\s\\xa0]*Ordspr(?:[a\\xE5]k|og)|Ordspr[a\\xE5]kene|Prov|Ordsp))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Predikerens|Eccl|Predikeren|Predikantens[\\s\\xa0]*bok|Fork(?:ynneren(?:s[\\s\\xa0]*bok)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:De[\\s\\xa0]*tre[\\s\\xa0]*menn(?:enes[\\s\\xa0]*sang[\\s\\xa0]*f\\xF8yer|s[\\s\\xa0]*sang)|SgThree))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S(?:alomos[\\s\\xa0]*(?:H\\xF8i|h\\xF8y)sa|o)ng|H\\xF8ys(?:angen)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        ...
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ob(?:ad(?:ja(?:s[\\s\\xa0]*bok)?|ias)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jona(?:s(?:[\\s\\xa0]*bok)?|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sef(?:an(?:ja(?:s[\\s\\xa0]*bok)?|ias))?|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hag(?:gai(?:s[\\s\\xa0]*bok)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sak(?:ar(?:ja(?:boken|s[\\s\\xa0]*bok)?|ias))?|Zech))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mal(?:aki(?:s[\\s\\xa0]*bok|as)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Matt(?:eusevangeliet|eus)?|Evangeliet[\\s\\xa0]*etter[\\s\\xa0]*Matteus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mark(?:usevangeliet|us)?|Evangeliet[\\s\\xa0]*etter[\\s\\xa0]*Markus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Luk(?:asevangeliet|e|as)?|Evangeliet[\\s\\xa0]*etter[\\s\\xa0]*Lukas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|F\xF8rste[\s\xa0]*Johannes|(?:F\xF8rste|1\.?)[\s\xa0]*Joh|Johannes’[\s\xa0]*f\xF8rste[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|Andre[\s\xa0]*Johannes|(?:Andre|2\.?)[\s\xa0]*Joh|Johannes’[\s\xa0]*andre[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|Tredje[\s\xa0]*Johannes|(?:Tredje|3\.?)[\s\xa0]*Joh|Johannes’[\s\xa0]*tredje[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Joh(?:annesevangeliet|n|annes)?|Evangeliet[\\s\\xa0]*etter[\\s\\xa0]*Johannes))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        ...
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Paulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*romerne|Rom(?:erbrevet|erne)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Andre|2\.?)[\s\xa0]*Korintierne)|(?:2(?:[\s\xa0]*(?:korinterbrev|Korinter)|Cor|\.[\s\xa0]*(?:korinterbrev|Korinter))|Andre[\s\xa0]*(?:korinterbrev|Korinter)|(?:Andre|2\.?)[\s\xa0]*Kor|Paulus’[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*korinterne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Korintierne)|(?:1(?:[\s\xa0]*(?:korinterbrev|Korinter)|Cor|\.[\s\xa0]*(?:korinterbrev|Korinter))|F\xF8rste[\s\xa0]*(?:korinterbrev|Korinter)|(?:F\xF8rste|1\.?)[\s\xa0]*Kor|Paulus’[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*korinterne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Paulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*galaterne|Gal(?:aterbrevet|aterne)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Efeserne)|(?:Paulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*efeserne|E(?:feserbrevet|ph|f)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Fil(?:ipperbrevet|ipperne|ippenserne)?|P(?:aulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*filipperne|hil)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kolosse(?:nse)?rne)|(?:Paulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*kolosserne|Kolosserbrevet|Col|Kol))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Andre|2\.?)[\s\xa0]*Tessalonikerne)|(?:2(?:[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|Thess|\.[\s\xa0]*(?:tessalonikerbrev|Tessaloniker))|Andre[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|(?:Andre|2\.?)[\s\xa0]*Tess|Paulus’[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*tessalonikerne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Tessalonikerne)|(?:1(?:[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|Thess|\.[\s\xa0]*(?:tessalonikerbrev|Tessaloniker))|F\xF8rste[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|(?:F\xF8rste|1\.?)[\s\xa0]*Tess|Paulus’[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*tessalonikerne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Timoteusbrev|Tim|\.[\s\xa0]*Timoteusbrev)|Andre[\s\xa0]*Timoteusbrev|2(?:\.[\s\xa0]*Tim(?:oteus)?|[\s\xa0]*Tim(?:oteus)?)|Andre[\s\xa0]*Tim(?:oteus)?|Paulus’[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*Timoteus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Timoteusbrev|Tim|\.[\s\xa0]*Timoteusbrev)|F\xF8rste[\s\xa0]*Timoteusbrev|1(?:\.[\s\xa0]*Tim(?:oteus)?|[\s\xa0]*Tim(?:oteus)?)|F\xF8rste[\s\xa0]*Tim(?:oteus)?|Paulus’[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*Timoteus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Brevet[\\s\\xa0]*til[\\s\\xa0]*Titus|Tit(?:us)?|Paulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*Titus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Filem(?:onbrevet|on)?|Brevet[\\s\\xa0]*til[\\s\\xa0]*Filemon|P(?:aulus’[\\s\\xa0]*brev[\\s\\xa0]*til[\\s\\xa0]*Filemon|hlm)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hebreerne)|(?:Brevet[\\s\\xa0]*til[\\s\\xa0]*hebreerne|Heb(?:reerbrevet|r)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ja(?:k(?:ob(?:s(?:[\\s\\xa0]*brev)?)?)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Andre|2\.?)[\s\xa0]*Petersbrev)|(?:(?:Andre|2\.?)[\s\xa0]*Peters)|(?:2(?:[\s\xa0]*Peter|Pet|\.[\s\xa0]*Peter)|Andre[\s\xa0]*Peter|(?:Andre|2\.?)[\s\xa0]*Pet|Peters[\s\xa0]*andre[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Petersbrev)|(?:(?:F\xF8rste|1\.?)[\s\xa0]*Peters)|(?:1(?:[\s\xa0]*Peter|Pet|\.[\s\xa0]*Peter)|F\xF8rste[\s\xa0]*Peter|(?:F\xF8rste|1\.?)[\s\xa0]*Pet|Peters[\s\xa0]*f\xF8rste[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tob(?:i(?:t(?:s[\\s\\xa0]*bok)?|as['’][\\s\\xa0]*bok))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Andre[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Tredje[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Fjerde[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|F\xF8rste[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c64 = "ittelet",
        peg$c65 = peg$literalExpectation("ittelet", false),
        peg$c66 = "ittel",
        peg$c67 = peg$literalExpectation("ittel", false),
        peg$c68 = "itler",
        peg$c69 = peg$literalExpectation("itler", false),
        peg$c70 = "itlene",
        peg$c71 = peg$literalExpectation("itlene", false),
        peg$c72 = "itel",
        peg$c73 = peg$literalExpectation("itel", false),
        ...
        peg$c86 = "og",
        peg$c87 = peg$literalExpectation("og", false),
        peg$c88 = "cf",
        peg$c89 = peg$literalExpectation("cf", false),
        peg$c90 = "jf",
        peg$c91 = peg$literalExpectation("jf", false),
        peg$c92 = function() { return "" },
        peg$c93 = /^[\-\u2013\u2014]/,
        peg$c94 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c95 = "overskrift",
        peg$c96 = peg$literalExpectation("overskrift", false),
