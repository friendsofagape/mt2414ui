          ...
          <div className="col-md-12 col-md-4 col-md-offset-4 bodyColor bodyBorder">       
            <form onSubmit={this.onForgotPassword}>
              ...
              <div className="form-group">
                <label className="control-label" id="temppasswordLabel"> <strong>Temporary Password </strong> </label>
              ...
              <div className="form-group">
                <label className="control-label" id="passwordLabel"> <strong>New Password </strong> </label>
              ...
              <div className="form-group">
                <label className="control-label" id="passwordConfirmLabel"> <strong> Confirm New Password </strong> </label>
