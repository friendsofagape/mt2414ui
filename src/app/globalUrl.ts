export class GlobalUrl {
    ...
    //In case of get request this api Returns list of positional pairs, list of Hindi words, list of strong numbers for the bcv queried. 
    // and in case of post it updates the corresponding Verses alignments as per the corrections made by user.
    getnUpdateBCV: string = 'https://api.autographamt.com/v2/alignments';

    //Returns a list of books whose alignments are available
    getBooks: string = 'https://api.autographamt.com/v2/alignments/books';

    //Returns a list of chapter number of the book queried.
    getChapters: string = 'https://api.autographamt.com/v2/alignments/chapternumbers/';

    //Returns a list containing the verse numbers for the particular chapter number of a book.
    getVerses: string = 'https://api.autographamt.com/v2/alignments/versenumbers/';

    //Returns the lexicon data for the corresponding greek strong number
    getLexicon: string = 'https://api.autographamt.com/v2/lexicons';

    //Saves the new approved alignments in the feedback lookup table for further use
    approveAlignments: string = 'https://api.autographamt.com/v2/alignments/feedbacks';

    //Saves the new approved alignments in the feedback lookup table for further use
    fixAlignments: string = 'https://api.autographamt.com/v2/alignments/feedbacks/verses';

    //Fetch the whole bible alignment
    grkhin: string = 'https://api.autographamt.com/v2/alignments/export';
    ...
    //Fetch all the available language list
    getLang: string = 'https://api.autographamt.com/v2/alignments/languages';

    //Fetch BCV number
    getBcvSearch: string = 'https://api.autographamt.com/v2/searchreferences';

    //ResetPassword API
    resetPassword: string = 'https://api.autographamt.com/v2/resetpassword';

    //Registration API
    //registration: string = 'https://api.autographamt.com/v1/registrations';
    registration: string = 'https://api.autographamt.com/v2/registrations';

    //Auth API
    //auth: string = 'https://api.autographamt.com/v1/auth';
    auth: string = 'https://api.autographamt.com/v2/auth';

    //forgotPassword API
    forgotPassword: string = 'https://api.autographamt.com/v2/forgotpassword';

    //fetch translationwords API
    translationwords: string = "https://api.autographamt.com/v2/alignments/translationwords";

    //fetch list of strongs
    strongslist: string = "https://api.autographamt.com/v2/alignments/strongs";

    strongLexicon: string = "https://api.autographamt.com/v2/lexicons";

    requestOrganization: string = "https://api.autographamt.com/v2/users/organisations";

    createOrganization: string = "https://api.autographamt.com/v2/organisations";

    createProject: string = "https://api.autographamt.com/v2/projects";

    userList: string = "https://api.autographamt.com/v2/users";

    assignments: string = "https://api.autographamt.com/v2/assignments";

    taskListForUser:string = "https://api.autographamt.com/v2/users/assignments";

    userListProjectWise:string = "https://api.autographamt.com/v2/projects/users";

    reports = "https://api.autographamt.com/v2/alignments/reports";

    feedbackForm = "https://api.autographamt.com/v2/feedbacks";

    getTarget = "https://api.autographamt.com/v2/alignments/targetlanguages";
